...
Defined in: [src/Mnemonic/types.ts:891](https://github.com/thirtytwobits/react-mnemonic/blob/5dd792d6e056ac2a6094081133428cfe73e4a5b3/src/Mnemonic/types.ts#L891)
...
thrown reaches [MnemonicProviderOptions.onStorageError](../interfaces/MnemonicProviderOptions.md#onstorageerror) as an `"access"`
...
is reported by [Mnemonic.unpersistedKeys](Mnemonic.md#unpersistedkeys) and can be re-attempted with
[Mnemonic.flush](Mnemonic.md#flush) once the backend is healthy again. Logging is squelched
per failure streak, so those queues and
[MnemonicProviderOptions.onStorageError](../interfaces/MnemonicProviderOptions.md#onstorageerror) — not the console — are the
...
Defined in: [src/Mnemonic/types.ts:936](https://github.com/thirtytwobits/react-mnemonic/blob/5dd792d6e056ac2a6094081133428cfe73e4a5b3/src/Mnemonic/types.ts#L936)
...
Defined in: [src/Mnemonic/types.ts:963](https://github.com/thirtytwobits/react-mnemonic/blob/5dd792d6e056ac2a6094081133428cfe73e4a5b3/src/Mnemonic/types.ts#L963)
...
Defined in: [src/Mnemonic/types.ts:900](https://github.com/thirtytwobits/react-mnemonic/blob/5dd792d6e056ac2a6094081133428cfe73e4a5b3/src/Mnemonic/types.ts#L900)
...
Defined in: [src/Mnemonic/types.ts:929](https://github.com/thirtytwobits/react-mnemonic/blob/5dd792d6e056ac2a6094081133428cfe73e4a5b3/src/Mnemonic/types.ts#L929)
...
Defined in: [src/Mnemonic/types.ts:919](https://github.com/thirtytwobits/react-mnemonic/blob/5dd792d6e056ac2a6094081133428cfe73e4a5b3/src/Mnemonic/types.ts#L919)
...
Defined in: [src/Mnemonic/types.ts:910](https://github.com/thirtytwobits/react-mnemonic/blob/5dd792d6e056ac2a6094081133428cfe73e4a5b3/src/Mnemonic/types.ts#L910)
